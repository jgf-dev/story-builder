...
class TestEnvModule(unittest.TestCase):
    ...
    def test_load_env_single_call(self, mock_load_dotenv):
        import storybuilder.utils.env as env_module
        env_module._env_loaded = False
        env_module.load_env()
        env_module.load_env()
    ...
    @patch("storybuilder.utils.env.load_dotenv")
    def test_load_env_with_custom_path(self, mock_load_dotenv):
        import storybuilder.utils.env as env_module
        env_module._env_loaded = False
    ...
    @patch("storybuilder.utils.env.load_dotenv")
    def test_get_api_key_required_success(self, mock_load_dotenv):
        import storybuilder.utils.env as env_module
        env_module._env_loaded = False
    ...
    @patch("storybuilder.utils.env.load_dotenv")
    def test_get_api_key_required_missing(self, mock_load_dotenv):
        import storybuilder.utils.env as env_module
        env_module._env_loaded = False
    ...
    @patch("storybuilder.utils.env.load_dotenv")
    def test_get_api_key_optional_missing(self, mock_load_dotenv):
        import storybuilder.utils.env as env_module
        env_module._env_loaded = False
    ...
    @patch("storybuilder.utils.env.load_dotenv")
    def test_get_stable_api_key_single_key(self, mock_load_dotenv):
        import storybuilder.utils.env as env_module
        env_module._env_loaded = False
    ...
    @patch("storybuilder.utils.env.load_dotenv")
    def test_get_stable_api_key_returns_only_primary(self, mock_load_dotenv):
        import storybuilder.utils.env as env_module
        env_module._env_loaded = False
        os.environ["GEMINI_API_KEY"] = "primary-key"
    ...
    @patch("storybuilder.utils.env.load_dotenv")
    def test_get_api_keys_with_rotation_all(self, mock_load_dotenv):
        import storybuilder.utils.env as env_module
        env_module._env_loaded = False
        os.environ["GEMINI_API_KEY"] = "primary-key"
        os.environ["GEMINI_API_KEY_1"] = "rotated-key-1"
    ...
    @patch("storybuilder.utils.env.load_dotenv")
    def test_get_api_keys_with_rotation_primary_only(self, mock_load_dotenv):
        import storybuilder.utils.env as env_module
        env_module._env_loaded = False
        os.environ["GEMINI_API_KEY"] = "primary-key"
        result = env_module.get_api_keys_with_rotation("GEMINI_API_KEY")
    ...
    @patch("storybuilder.utils.env.load_dotenv")
    def test_get_api_keys_with_rotation_none(self, mock_load_dotenv):
        import storybuilder.utils.env as env_module
        env_module._env_loaded = False
        result = env_module.get_api_keys_with_rotation("GEMINI_API_KEY")
...
class TestLoggingConfig(unittest.TestCase):
    ...
    def test_configure_logging_single_call(self, mock_basicConfig):
        import storybuilder.utils.logging_config as lc
        lc._configured = False
    ...
    @patch("storybuilder.utils.logging_config.logging.basicConfig")
    def test_configure_logging_with_force(self, mock_basicConfig):
        import storybuilder.utils.logging_config as lc
        lc._configured = False
        lc.configure_logging()
