...
def process_files(input_dir):
    ...
    for filepath in files:
        ...
        for line in lines:
            ...
            if adjacent_tags:
                print(f"WARNING: Adjacent tags detected (will cause TTS API error). "
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Split TTS scene prompts to respect the 2-voice limit and output length constraints.")
